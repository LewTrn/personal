...
window.addEventListener("load", () => {
  ...
  // Enable responsive mode for specified viewport widths
  ...
  const handleEvent = () => (send.disabled = !(email.value && message.value));

  email.addEventListener("input", () => handleEvent());
  message.addEventListener("input", () => handleEvent());
});
